(function($){
    $.fn.yxMobileSlider = function(settings){
        var defaultSettings = {
            width: window.screen.width, //容器宽度
            height: window.screen.height/4, //容器高度
            during: 5000, //间隔时间
            speed:30 //滑动速度
        }
        ...
        return this.each(function(){
            ...
            var positionLeft = moveWidth / 2 - 50 + 'px';
            //初始化主体样式
            ...
            //初始化焦点容器及按钮
            _this.append('<div class="focus"><div style="display: inline-block;text-align: center;width: 100%"></div></div>');
