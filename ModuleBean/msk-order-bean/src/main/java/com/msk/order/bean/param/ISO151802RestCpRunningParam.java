 ...
 */
public class ISO151802RestCpRunningParam extends BaseRestParam {
     ...
     * 退回费用明细列表
     */
    private List<ISO151802RestFundDetailParam> refundDetailList;

    /**
     * <p>默认构造函数。</p>
     */
    public ISO151802RestCpRunningParam() {
    }
    ...
    public List<ISO151802RestFundDetailParam> getRefundDetailList() {
        return refundDetailList;
    }

    public void setRefundDetailList(List<ISO151802RestFundDetailParam> refundDetailList) {
