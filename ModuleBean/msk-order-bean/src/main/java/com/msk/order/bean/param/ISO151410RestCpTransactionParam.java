 ...
 */
public class ISO151410RestCpTransactionParam extends BaseEntity {
     ...
     * 退回费用明细列表
     */
    private List<ISO151410RestFundDetailParam> refundDetailList;
    ...
    public List<ISO151410RestFundDetailParam> getRefundDetailList() {
        return refundDetailList;
    }

    public void setRefundDetailList(List<ISO151410RestFundDetailParam> refundDetailList) {
