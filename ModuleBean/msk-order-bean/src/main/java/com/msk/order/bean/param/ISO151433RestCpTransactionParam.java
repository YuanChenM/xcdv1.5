 ...
 */
public class ISO151433RestCpTransactionParam extends BaseEntity {
    ...
    private List<ISO151433FundDetailParam> refundDetailList;//退回费用明细列表
    ...
    public List<ISO151433FundDetailParam> getRefundDetailList() {
        return refundDetailList;
    }

    public void setRefundDetailList(List<ISO151433FundDetailParam> refundDetailList) {
