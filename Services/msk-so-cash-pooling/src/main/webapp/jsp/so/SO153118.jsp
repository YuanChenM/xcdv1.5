...
<div class="page-content list-page">
    <form:form action="${ctx}/SO153118/update" id="SO153118Param"
               metdod="post" enctype="multipart/form-data">
        <table id="SO153118DataGrid">
            ...
            <tr>
                <td align="right">
                    <msk2:button buttonType="button" buttonId="SO153118.SAVE" buttonValue="保存"/>
                </td>
                <td align="left">
                    <msk2:button buttonType="button" buttonId="SO153118.BACK" buttonValue="取消"/>
                </td>
            </tr>
        </table>
...
<!-- Add for Bug#1652 by li_huiqian at 2016/9/8 start -->
<script src="${ctx}/static/so/js/SO153118.js"></script>