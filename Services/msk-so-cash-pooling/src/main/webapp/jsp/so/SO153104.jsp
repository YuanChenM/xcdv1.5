...
<div class="page-content list-page">
    <form:form action="${ctx}/SO153104/update/${buyerBillId}/${ver}/${srcPage}" id="so153104Param"
               metdod="post" enctype="multipart/form-data">
        <table id="SO153104DataGrid">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="paidAmount" name="paidAmount" value="${orderAmount}"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right">
                    <msk2:button buttonType="button" buttonId="SO153104.SAVE" buttonValue="保存"/>
                </td>
                <td align="left">
                    <msk2:button buttonType="button" buttonId="SO153104.BACK" buttonValue="取消"/>
                </td>
            </tr>
        </table>
    </form:form>
...
<!-- Add for Bug#1652 by li_huiqian at 2016/9/8 start -->
<script src="${ctx}/static/so/js/SO153104.js"></script>