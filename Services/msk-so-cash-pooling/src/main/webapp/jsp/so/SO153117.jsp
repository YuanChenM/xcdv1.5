...
<div class="page-content list-page">
    <form:form action="${ctx}/SO153117/update" id="SO153117Param"
               metdod="post" enctype="multipart/form-data">
        <table id="SO153117DataGrid">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="suppCodeName" name="suppCodeName" value="${suppCodeName}"
                           readonly="true"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right">
                    <msk2:button buttonType="button" buttonId="SO153117.SAVE" buttonValue="保存"/>
                </td>
                <td align="left">
                    <msk2:button buttonType="button" buttonId="SO153117.BACK" buttonValue="取消"/>
                </td>
            </tr>
        </table>
...
<!-- Add for Bug#1652 by li_huiqian at 2016/9/8 start -->
<script src="${ctx}/static/so/js/SO153117.js"></script>