var SO153116 = {
    formId: "SO153116Param",
    saveButtonId: "SO153116_SAVE",
    backButtonId: "SO153116_BACK",
    operateTimeT: "#operateTime",
    init: function () {
        this.bindSavebutton();
        this.bindBackbutton();
        this.bindDatePicber(SO153116.operateTimeT),
            this.changeSelect();
    },
    ...
    bindSavebutton: function () {
        $("#" + SO153116.saveButtonId).click(function () {
            SO153116.uploadData();
        });
    },
    bindBackbutton: function () {
        $("#" + SO153116.backButtonId).click(function () {
            $.pdialog.close();
        });
    },
    uploadData: function () {
        $.alertMessage.confirm("你确定要保存当前数据吗？", function () {
            $.alertMessage.close();
            var formData = getFormData($("#" + SO153116.formId));
            var count = 0;
            // Modify for Bug#1652 by li_huiqian at 2016/9/8 start
            // 必须check
            $("#SO153116DataGrid>tbody>tr").each(function () {
                // 重置输出框颜色
            ...
            if (count > 0) {
                ...
                var fromUrl = $("#" + SO153116.formId).attr("action");
