var SO153103 = {
    formId: "so153103Param",
    saveButtonId: "SO153103_SAVE",
    backButtonId: "SO153103_BACK",
    operateTimeT: "#operateTime",
    init: function () {
        this.bindSavebutton();
        this.bindBackbutton();
        this.bindDatePicber(SO153103.operateTimeT);
        this.changeSelect();
    },
    ...
    bindSavebutton: function () {
        $("#" + SO153103.saveButtonId).click(function () {
            SO153103.uploadData();
        });
    },
    bindBackbutton: function () {
        $("#" + SO153103.backButtonId).click(function () {
            $.pdialog.close();
        });
    },
    uploadData: function () {
        $.alertMessage.confirm("你确定要保存当前数据吗？", function () {
            $.alertMessage.close();
            var formData = getFormData($("#" + SO153103.formId));
            var count = 0;
            ...
            //if ((refundType == '0' || refundType == '1') && backNo == '') {
            //    count++;
            ...
            if (count > 0) {
                ...
                var fromUrl = $("#" + SO153103.formId).attr("action");
