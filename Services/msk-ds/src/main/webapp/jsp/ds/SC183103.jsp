                ...
                <tr>
                    ...
                    <td>
                        <select style="width: 133px" name="filterMap['halfCode']" id="halfCode" disabled>
                            <option value="${halfParam.halfCode}">${halfParam.halfName}<%--<msk:codemaster codeType="HalfCodeType" viewType="label" codeValue="${halfParam.halfName}" />--%></option>
                            <input type="hidden" name ="filterMap['halfCode']" value ="${halfParam.halfCode}"/>
                        </select>
                    </td>
                    <td></td>
                    <td>录入日期</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="productParamList[${i.index}].changeNum" id="changeNum${planChangeProduct.productCode}" value="0.00" readonly="readonly" style="background:#DBDBDB;text-align: right"
                                   maxlength="18" max="99999999999999.99" number="true" numberMessage="计算后的调整值必须为数字,长度不能大于14(可带两位小数)!"/>
                        </td>
                        <td>
                            <input type="text" name="changeBoxes" id="changeBoxes${planChangeProduct.productCode}" style="text-align: right" value="0"
                                   maxlength="15" max="99999999999999" number="true" digitsMessage="调整箱数必须为整数,最大长度14!"/>
                        </td>
                        <td>
...
<script type="text/javascript" src="${ctx}/static/ds/js/SC183103.js"></script>
