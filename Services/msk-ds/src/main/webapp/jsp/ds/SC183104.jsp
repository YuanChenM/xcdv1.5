...
<navigation:header title="供应商产品实际录入历史一览" backTitleArray=" " backUrlArray=" "></navigation:header>
<div class="page-content list-page">

    <form action="${ctx}/SC183104/search" method="post">
        <table id="SC183104_Grid">
            <thead>
            <tr>
                <th coltype="text" name="suppDsId" filter="true" >供应商分销流水号</th>
                <th coltype="text" name="actualFlowId" filter="true" >库存实际流水号</th>
                <th coltype="text" name="distMonth" filter="true">分销月度</th>
                <%--<th coltype="text" name="lgcsCode" filter="true">物流区码</th>--%>
                <th coltype="text" name="lgcsName" filter="true">物流区域</th>
                <%--<th coltype="text" name="suppCode" filter="true">供应商编码</th>--%>
                ...
                <th coltype="text"  name="classesName" filter="true">产品类别</th>
                <th coltype="text"  name="breedName" filter="true">产品品种</th>
                <th coltype="text"  name="featureName" filter="true">产品特征</th>
                <%-- Modify for 2781 at 2016/09/22 by likai Start --%>
                <%--<th coltype="text"  name="gradeName" filter="true">产品等级</th>--%>
                ...
                <th coltype="datetime"  name="inputDate" filter="true">录入日期</th>
                <th coltype="money" accuracy="2"  name="oldActualNum" filter="false">原实际重量(KG)</th>
                <th coltype="money" accuracy="2" name="newActualNum" filter="false">新实际重量(KG)</th>
       ...
       <%-- <table><tr align="left"><msk:button buttonValue="新建" buttonId="SC183104.NEW" buttonType="button" url="${ctx}/SC182102/init"/></tr></table>--%>
    </form>
</div>
<script type="text/javascript" src="${ctx}/static/ds/js/SC183104.js"></script>
