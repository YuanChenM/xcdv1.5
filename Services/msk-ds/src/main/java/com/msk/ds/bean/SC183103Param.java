 ...
 */
public class SC183103Param extends BaseParam{
    /** serialVersionUID */
    ...
    /**虚拟库存商品列表*/
    private List<SC183103ProductParam> productParamList;
    ...
    public List<SC183103ProductParam> getProductParamList() {
        return productParamList;
    }

    public void setProductParamList(List<SC183103ProductParam> productParamList) {
