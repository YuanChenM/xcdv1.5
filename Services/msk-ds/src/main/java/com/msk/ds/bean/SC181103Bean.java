...
public class SC181103Bean extends BaseEntity {
    ...
    private String deliveryBoxes;

    public String getDeliveryBoxes() {
        return deliveryBoxes;
    }

    public void setDeliveryBoxes(String deliveryBoxes) {
    ...
    public String getPdName() {
        ...
        if(StringUtil.isNullOrEmpty(this.gradeCode))
        {
            name += "/" + this.gradeName;
        }
...
//    public String getBrandTypeName() {return brandTypeName}
...
//        }
    ...
    public String getEpName() { return epName; } public void setEpName(String epName) {
        this.epName = epName;
    }
}
