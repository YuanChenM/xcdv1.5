...
<div class="page-content list-page">
  <form action="${ctx}/SP99999/search"  method="post" id="SP99999Form" >
    ...
    <div class="group-accordion" collapsible="false" active="false" >
      ...
      <table width="100%">
        <tr>
          ...
          <td><msk:button buttonValue="查询" buttonType="button" buttonId="SP99999.SEARCH"/></td>
          <td><msk:button buttonValue="编辑" buttonType="button" buttonId="SP99999.UPDATE"/></td>
        </tr>
      </table>
    </div>
    <div style="width: 100%;overflow: scroll;">
      <table id="SP99999_list_grid" width="100%">
        <thead>
        <tr>
          ...
          <th coltype="text"   name="wayGradeName" rowspan="3" style="white-space : normal;">营销状态</th>
  ...
  <div>
    <table>
      <tr>
        <td><msk:button buttonValue="保存" buttonType="button" buttonId="SP99999.SAVE"/></td>
        <td><msk:button buttonValue="价盘导出" buttonType="button" buttonId="SP99999.EXPORT"/></td>
        <td><msk:button buttonValue="价盘导出(poi)" buttonType="button" buttonId="SP99999.EXPORTPOI"/></td>
        <td>
          <form action="${ctx}/SP171171/upload" id="SP99999UploadForm"   method="post" enctype="multipart/form-data">
            <table width="100%">
              <tr>
                <td  align="left" colspan="6">　
                  <input type="hidden" id="userId" value="${loginUser.emplId}"/>
                  <input type="file" name="file" id="importFile" style="width:180px"/>
                  <msk:button buttonValue="上传" buttonId="SP99999.UPLOAD" buttonType="button"/>
                </td>
              </tr>
            </table>
          </form>
...
<script src="${ctx}/static/sp/js/SP99999.js"></script>
