...
@ApiModel(value = "IBS210110301Bean",description = "bean")
public class IBS210110301Bean  extends BaseBean {
    //SlSeller
    ...
    @ApiModelProperty(value = "配送站")
    private java.lang.String distribution;
    @ApiModelProperty(value = "领地")
