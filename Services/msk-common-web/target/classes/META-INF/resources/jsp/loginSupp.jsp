...
<div>
    ...
    <form method="post" action="${ctx}/loginForSupp" id="loginForm">
        ...
        <div class="wrapper">
            ...
            <div class="login_middle" style="background: url('${ctx}/static/login/images/wallpaper-1.png') no-repeat center;">
                <div id="background" class="login_box_bg">
                    ...
                    <div id="newVersionLogin" class="form login-backgroud-color">
                            ...
                            <tr>
                                ...
                                <td style="height:50px;padding: 5px;">
                                    ...
                                    <input id="userName" class="module_app_input___gray_neoskin"
                                           style="margin-left:15px;" placeholder="用户名/手机号码" type="text" value="" tabindex="1"
                        ...
                        <div class="dashed_bottom btn_wrap login-backgroud-color">
            ...
            <div class="foot" id="footer">
                <ul class="links ft">
                    <%--<li class="links_item"><a href="${ctx}/saler/login">卖家供应链系统</a></li>--%>
                    <li class="links_item"><a href="${ctx}/sps/login">云冻品分销供应链</a></li>
                </ul>
            </div>
            <div>
