 ...
 */
var MainUtils = {
    uploadProcessListenWithFunc : function(taskId,message, func){
        $.ajax(
            {
                method:"GET",
                ...
                success:function(data){
                    if(data!=undefined && data.errorMessage != null && data.errorMessage != ''){
                        HDF.closeLoadingMask();
                        $.alertMessage.info(data.errorMessage);
                    }
                    else if(data[taskId] == "S"){
                        HDF.closeLoadingMask();
                        ...
                        HDF.closeLoadingMask();
                        MainUtils.uploadProcessListenWithFunc(taskId,data.taskId, func);
                    }
    ...
    uploadExcelFileWithFunc:function(url,fileTagName,param, func){
        $("input[name="+fileTagName+"]").upload({
            ...
            onComplate: function (data) {
                ...
                MainUtils.uploadProcessListenWithFunc(taskId,"数据后台处理中.....", func);
            },
        ...
        $.ajax(
            {
                ...
                success:function(data){
                    if(data!=undefined && data.errorMessage != null && data.errorMessage != ''){
                        ...
                        HDF.closeLoadingMask();
                        MainUtils.uploadProcessListen(taskId,data.taskId);
                    }
