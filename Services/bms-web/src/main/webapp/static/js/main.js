...
var Main = {
		...
		$("#favorites").click(function(){
			...
			function(result){
				if(result=="HAS") {
                    ...
                    $(".toolbar").append('<li style="color: skyblue;" class="last"><a href="'
					+ pageUrl
					+ '" target="ajax" rel="main-content"><span style="background: url( '+ Main.contextPath + '/static/images/action/lost.png) no-repeat center;"></span>'
	...
	//highlight MainMenu by pageCode for url page switch -- liu_yan2
	hlLeftMainMenu: function(pageCode) {
	$(".menu_content .sub_menu .ui-menu-item[selected=selected]").each(function() {
		$(this).removeAttr("selected");
	});
	$(".menu_content .sub_menu .ui-menu-item[href*='"+pageCode+"']").attr("selected", "selected");
}
};
