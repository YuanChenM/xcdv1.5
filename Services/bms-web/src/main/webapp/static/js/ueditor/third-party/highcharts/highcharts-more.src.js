...
extend(Pane.prototype, {
	...
	init: function (options, chart, firstAxis) {
		...
		// To avoid having weighty service to place, update and remove the backgrounds,
		// push them to the first axis' plot bands and borrow the existing service there.
		if (backgroundOption) {
...
/**
 * Add service to pad each axis with the amount of pixels
...
/**
 * Add some special init service to areas and areasplines
 */
function initArea(proceed, chart, options) {
	...
	if (this.chart.polar) {
		...
		// Instead of complicated service to draw an area around the inner area in a stack,
		// just draw it behind
