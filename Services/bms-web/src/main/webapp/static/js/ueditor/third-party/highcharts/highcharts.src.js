 ...
 * Previously this service was part of getTimeTicks, but as getTimeTicks now runs
 * of segments in stock charts, the normalizing service was extracted in order to
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		animate: function (el, params, options) {
			...
			if (params.opacity !== UNDEFINED && el.attr) {
				params.opacity += 'px'; // force jQuery to use same service as width and height (#2161)
			}
...
Tick.prototype = {
	 ...
	 * detection with overflow service.
	 */
...
Axis.prototype = {
	...
	defaultLabelFormatter: function () {
		...
		if (formatOption) {
			...
			// service to the numberFormatter and enable it by a parameter.
	...
	/**
	 * Return the minor tick positions. For logarithmic axes, reuse the same service
	 * as for major ticks.
	 */
...
Pointer.prototype = {
	 ...
	 * a one-to-one assignment between methods and their handlers. Any advanced service should
...
var ColumnSeries = extendClass(Series, {
	...
	getColumnMetrics: function () {
		...
		// This is called on every series. Consider moving this service to a
...
var PieSeries = {
	...
	translate: function (positions) {
		...
		// utility for getting the x value from a given y, used for anticollision service in data labels
