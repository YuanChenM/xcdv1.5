...
<div class="page-content list-page">
    <form action="<c:url value="/SO152501/search/"/>" id="SO152501Form" method="post">
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="text" name="filterMap['warehouseCode']" id="warehouseCode"
                                   value="${param.filterMap.warehouseCode}" maxlength="20"/></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="filterMap['supplierCode']" id="supplierCode"
                                   value="${param.filterMap.supplierCode}" maxlength="20"/></td>
                        <td width="15%" align="right">产品编码</td>
                        <td><input type="text" align="right" name="filterMap['pdCode']" id="pdCode"
                                   value="${param.filterMap.pdCode}" maxlength="10"/>
                            <input type="hidden" name="filterMap['supplyPlayFrom']" id="salePlatform" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="filterMap['supplierName']" id="supplierName"
                                   value="${param.filterMap.supplierName}" maxlength="100"/></td>
                        ...
                        <td width="15%"></td>
                        <td width="15%"></td>
                        <td align="left"><msk:button buttonValue="查询" buttonId="SO152501.SEARCH" buttonType="button"/></td>
                    </tr>
                </table>
            </div>
        </div>
...
<script src='<c:url value="/static/js/inventory/SO152501.js" />'></script>