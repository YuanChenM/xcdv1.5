 ...
 */
public class ISL231109RsParam extends BaseParam {
    private String slCode;//卖家编码
    private Integer prodEpId;//生产商企业ID
    private Integer brandEpId;//品牌商企业ID
    private Integer brandId;//产品品牌ID
    private String machiningCode;//产品二级分类
    private String pdClassesCode;//产品类别
    private String pdBreedCode;//产品品种
    private String pdFeatureCode;//产品特征
