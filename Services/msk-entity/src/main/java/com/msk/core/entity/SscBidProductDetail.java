...
/**
 * <p>表ssc_bid_product_detail对应的SscBidProductDetail。</p>
 *
 * @author 自动生成
 * @version 1.00
 */
public class SscBidProductDetail extends BaseEntity{
    /**
     * 
     */
