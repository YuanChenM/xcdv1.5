...
/**
 * <p>表so_cp_seller_bill_his对应的SoCpSellerBillHis。</p>
 *
 * @author 自动生成
 * @version 1.00
 */
public class SoCpSellerBillHis extends BaseEntity{
    /**
     * 
     */
    ...
    /** AJUST_DATE */
    private java.util.Date ajustDate;
    /** AJUST_AMOUNT */
    private java.math.BigDecimal ajustAmount;
    /** 3：减免 */
    private Integer ajustType;
    /** SELLER_BILL_NO */
     ...
     * <p>OPERATE_DATE。</p>
     *
     * @param operateDate OPERATE_DATE。
     */
     ...
     * <p>AJUST_DATE。</p>
     *
     * @return the AJUST_DATE
     */
    public java.util.Date getAjustDate() {
        return ajustDate;
    }
     ...
     * <p>AJUST_DATE。</p>
     *
     * @param ajustDate AJUST_DATE。
     */
    public void setAjustDate(java.util.Date ajustDate) {
     ...
     * <p>AJUST_AMOUNT。</p>
     *
     * @param ajustAmount AJUST_AMOUNT。
     */
     ...
     * <p>3：减免。</p>
     *
     * @param ajustType 3：减免。
     */
    public void setAjustType(Integer ajustType) {
