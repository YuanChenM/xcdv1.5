...
/**
 * <p>表pd_tnc_std_discuss_market对应的PdTncStdDiscussMarket。</p>
 *
 * @author 自动生成
 * @version 1.00
 */
public class PdTncStdDiscussMarket extends BaseEntity{
    /**
     * 
     */
    ...
    /**
     * <p>0:提出；1：结案；2：禁止准入。</p>
     *
     * @return the 0:提出；1：结案；2：禁止准入
     */
     ...
     * <p>0:提出；1：结案；2：禁止准入。</p>
     *
     * @param discussStatus 0:提出；1：结案；2：禁止准入。
     */
