...
/**
 * <p>表ssc_delivery_confirm_pr_detail对应的SscDeliveryConfirmPrDetail。</p>
 *
 * @author 自动生成
 * @version 1.00
 */
public class SscDeliveryConfirmPrDetail extends BaseEntity{
    /**
     * 
     */
    ...
    /** 产品已发货箱数 */
    private java.lang.Integer productDeliverBox;
    /** 不含包装离岸价 */
     ...
     * <p>默认构造函数。</p>
     */
    public SscDeliveryConfirmPrDetail() {
     ...
     * <p>发货订单编号。</p>
     *
     * @param deliveryConfirmCode 发货订单编号。
     */
     ...
     * @return the 产品已发货箱数
     */
    public java.lang.Integer getProductDeliverBox() {
        return productDeliverBox;
    }

    /**
     * <p>产品已发货箱数。</p>
     *
     * @param productDeliverBox 产品已发货箱数。
     */
    public void setProductDeliverBox(java.lang.Integer productDeliverBox) {
        this.productDeliverBox = productDeliverBox;
    }
