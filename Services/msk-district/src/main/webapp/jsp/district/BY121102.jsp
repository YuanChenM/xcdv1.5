...
<navigation:header title="省列表" backTitleArray="" backUrlArray=""></navigation:header>
<div class="page-content list-page">
    <form action="${ctx}/BY121102/search/${areaId}" method="post">
        <table id="BY121102_Grid">
            <thead>
            <tr>
                <th coltype="sno" width="20px">编号</th>
                <th coltype="text" name="provinceCode" edit="false" filter=true>省编码</th>
                <th coltype="text" name="provinceName" edit="false" filter=true>省名称</th>
...
<script type="text/javascript" src="${ctx}/static/district/js/BY121102.js"></script>
