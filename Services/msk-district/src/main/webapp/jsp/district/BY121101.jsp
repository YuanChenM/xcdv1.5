...
<navigation:header title="大区列表" backTitleArray="" backUrlArray=""></navigation:header>
<div class="page-content list-page">
    <form action="${ctx}/BY121101/search" method="post">
        <table id="BY121101_Grid">
            <thead>
            <tr>
                <th coltype="sno" width="20px">编号</th>
                <th coltype="text" name="areaCode" edit="false" filter=true>大区编码</th>
                <th coltype="text" name="areaName" edit="false" filter=true>大区名称</th>
                ...
                <th coltype="action">
                    ...
                    <input type="hidden"coltype="detail" title="编辑" class="h-button" />
...
<script type="text/javascript" src="${ctx}/static/district/js/BY121101.js"></script>
