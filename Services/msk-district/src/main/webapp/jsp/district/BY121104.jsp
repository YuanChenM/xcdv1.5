...
<navigation:header title="城市(地区)列表" backTitleArray="" backUrlArray=""></navigation:header>
<div class="page-content list-page">
    <form action="${ctx}/BY121104/search/${provinceId}/${lgcsAreaId}" method="post">
        <table id="BY121104_Grid">
            <thead>
            <tr>
                <th coltype="sno" width="20px">编号</th>
                <th coltype="text" name="cityCode" edit="false" filter=true>城市编码</th>
                <th coltype="text" name="cityName" edit="false" filter=true>城市名称</th>
                <th coltype="text" name="spell" edit="true" filter=true>拼音拼写</th>
                <th coltype="text" name="shortSpell" edit="true" filter=true>拼音缩写</th>
                <th coltype="text" name="shortCodeP" filter=true>短编码(省)</th>
                <th coltype="text" name="shortNameP" filter=true>短名称(省)</th>
                <th coltype="text" name="shortCodeL" filter=true>短编码(物)</th>
                <th coltype="text" name="shortNameL" filter=true>短名称(物)</th>
...
<script type="text/javascript" src="${ctx}/static/district/js/BY121104.js"></script>
