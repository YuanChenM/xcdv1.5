 ...
 */
public class IBY121314RsBean extends ByBuyerBasicInfo{

    /** 买家收货时间段*/
    private List<IBY121314RsBean> byBuyerRecTimeList;
    /** 收货时间段*/
    ...
    public List<IBY121314RsBean> getByBuyerRecTimeList() {
        return byBuyerRecTimeList;
    }

    public void setByBuyerRecTimeList(List<IBY121314RsBean> byBuyerRecTimeList) {
