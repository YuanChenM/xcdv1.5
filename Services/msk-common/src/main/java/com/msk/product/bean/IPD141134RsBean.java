...
/**
 * IPD141132RsBean.加工质量标准指标信息同步接口
 *
 * @author xhy
 */
@ApiModel(value = "IPD141134RsBean", description = "searchList")
public class IPD141134RsBean extends BaseEntity {
    ...
    @ApiModelProperty(value = "tncList")
    private List<IPD141134RsTncBean>  tncList;
    ...
    /**
     * Getter method for property <tt>tncList</tt>.
     *
     * @return property value of tncList
     */
    public List<IPD141134RsTncBean> getTncList() {
        return tncList;
    }

    /**
     * Setter method for property <tt>tncList</tt>.
     *
     * @param tncList value to be assigned to property tncList
     */
    public void setTncList(List<IPD141134RsTncBean> tncList) {
