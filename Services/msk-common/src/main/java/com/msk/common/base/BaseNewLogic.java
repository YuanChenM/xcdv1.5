...
public class BaseNewLogic {
    ...
    public <T extends Serializable> T findOne(BaseParam param) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> T findOne(Map<String, Object> param) {
        return this.baseDao.selectOne(this.getSqlId(CommSqlId.FIND_ONE), param);
    }
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> T findOne(String sqlId, BaseParam param) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> T findOne(String sqlId, Map<String, Object> param) {
        return this.baseDao.selectOne(this.getSqlId(sqlId), param);
    }
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> T load(BaseParam param) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> T load(String sqlId, Map<String, Object> paramMap) {
     ...
     */
    @Transactional
    public int remove(Serializable entity) {
     ...
     */
    @Transactional
    public int remove(String sqlId, Serializable entity) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> PageResult<T> findPage(BaseParam param, Class<T> clazz) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> List<T> findPageList(BaseParam param, Class<T> clazz) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> List<T> findList(String sqlId, BaseParam param) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> List<T> findList(BaseParam param) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> List<T> findList(Map<String, Object> paramMap, String sqlId) {
     ...
     */
    @Transactional
    public <T extends Serializable> int batchSave(List<T> entityList) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> List<T> findPageList(RsPageParam param) {
        return this.baseDao.selectList(getPageListSqlId(), param);
    }
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> List<T> findList(RsPageParam param) {
     ...
     */
    @Transactional(readOnly = true)
    public <T extends Serializable> List<T> findPageList(RsPageParam param, RsPageResult pageResult) {
    ...
    public void versionValidator(String tableName, String[] primaryKey, Object[] primaryKeyValue, int ver) {
        ...
        Serializable entity = this.baseDao.selectOne(sqlId, param);
        if (entity == null) {
