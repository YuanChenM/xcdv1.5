...
public final class RestClientUtil {
     ...
     *
     */
    public static <T extends Serializable> RsResponse<T> post(String url, Object param,TypeReference<RsResponse<T>> typeReference,SerializerFeature ... serializerFeature){
    ...
    private static String post(String url,String jsonParam){
        ...
        try {
            ...
            if(statusCode == HttpStatus.SC_NOT_FOUND){
                ...
                throw new Restful404Exception("Http 返回失败，Http失败状态为："+statusCode);
            }
    ...
    //Modif for Bug#2508 at 2016/09/07 by jiang_nan Start
    ...
    //Modif for Bug#2508 at 2016/09/07 by jiang_nan end
