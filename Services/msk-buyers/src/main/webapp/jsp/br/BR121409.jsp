<%--
    Title:冻品管家分销分类买家池营销期公众买家分池买家注册管控
    author:tao_zhifa
...
<navigation:header title="销售期公众买家报表" backTitleArray="" backUrlArray=""></navigation:header>
        ...
        <table width="100%">
            ...
            <tr>
                <td align="right" width="12.5%">
                    <%--<msktag:button buttonValue="查询" buttonId="BR121409.SEARCH"  buttonType="button"/>--%>
                    <msk:button buttonValue="生成" buttonId="BR121409.SAVEBTN" buttonType="button" coltype="save"
                                class="h-button" align="center" useable="can_generate"/>
                </td>
            </tr>
        </table>
    </div>
    <form action="${ctx}/BR121409/search" id="BR121409Form" method="post">
    <div>
        <table width="100%" id="BR121409_list_grid">
            <thead>
            <tr>
                <th coltype="sno" align="center" width="15%">编号</th>
                <th coltype="text" name="fileName" filter="true"  align="center" WIDTH="40%">分销买家池销售期公众买家分池买家注册管控表</th>
...
<script src="${ctx}/static/br/js/BR121409.js"></script>