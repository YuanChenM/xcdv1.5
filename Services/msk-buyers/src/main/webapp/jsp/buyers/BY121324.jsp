...
<div class="page-content list-page">
    <form action="${ctx}/BY121324/search" id="BY121324Form" method="post">
        ...
        <table width="100%" cellspacing=8>
            ...
            <tr>
                <td align="right" >
                    <msk:button buttonValue="" buttonId="BY121324.CREATE"  coltype="download"
...
<script src="${ctx}/static/buyers/js/BY121324.js"></script>
