...
var BY121322 = {
    ...
    initDataGrid:function(){
        $List_Grid = $('#BY121322_list_grid').grid({});
        this.bindDatePicber(BY121322.startTime);
        this.bindDatePicber(BY121322.endTime);
    ...
    //绑定查询按钮
    searchData: function () {
        $("#" + BY121322.searchButtonId).click(function () {
            var startTime= $("#startTime").val();
            var endTime= $("#endTime").val();
            if(startTime =="" && endTime==""){
                FormUtils.setFormValue(BY121322.formId, "BY121322");
                $List_Grid.fnDraw();
