...
/**
 * Created by jiang_tengfei on 2016/6/12.x
 */
public class BBR12140201Param extends BaseParam {
    ...
    private int flag;
    //上个月开始时间
    private Date lastMonthStartDay;
    //上个月结束时间
    private Date lastMonthEndDay;
    ...
    public Date getLastMonthStartDay() {
        return lastMonthStartDay;
    }

    public void setLastMonthStartDay(Date lastMonthStartDay) {
        this.lastMonthStartDay = lastMonthStartDay;
    }

    public Date getLastMonthEndDay() {
        return lastMonthEndDay;
    }

    public void setLastMonthEndDay(Date lastMonthEndDay) {
        this.lastMonthEndDay = lastMonthEndDay;
    }
