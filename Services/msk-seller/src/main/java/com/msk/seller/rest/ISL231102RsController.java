 ...
 */
@RestController
public class ISL231102RsController extends BaseRsController {
    /**
     * logger
     */
    private static Logger logger = LoggerFactory.getLogger(ISL231102RsController.class);
    @Autowired
     ...
     * @return rs
     */
    @RequestMapping(value = "/slInfo/slAccount/new",method = RequestMethod.POST,produces = {MediaType.APPLICATION_JSON_VALUE})
