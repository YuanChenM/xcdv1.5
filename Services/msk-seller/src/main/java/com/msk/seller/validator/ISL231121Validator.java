 ...
 */
public class ISL231121Validator extends BaseValidator<RsRequest<SlSeller>> {
    ...
    public void validatorData(RsRequest<SlSeller> entity) {
        ...
        if (null != slSeller) {
            ...
            this.validatorRequired("更新者ID", slSeller.getUpdId());
            this.validatorRequired("版本号", slSeller.getVer());
        }
    }
