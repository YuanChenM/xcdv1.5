...
<navigation:header title="卖家产品加工质量标准" backTitleArray="产品待审批审核卖家列表"
    ...
    <form id="searchForm" action="${ctx}/SL241105/search/${isFeature}" method="post">
        ...
        <table id="SL241104_Grid">
            ...
            <tr>
                ...
                <th coltype="select" filter="true" name="slTncGradeCode" align="center">产品定级
                    <select>
                ...
                <th coltype="text" align="center" name="tncNgReason" width="30px">不通过原因</th>
                <th coltype="select" filter="true" name="tncMonitorResult" align="center">
                    监控人审核
                    <select>
                ...
                <th coltype="action">定级确认
                    <msk2:button buttonType="hidden" buttonId="SL241104.CHECKBTN" coltype="check" buttonValue="确认" class="h-button"/>
                    <%--<input type="hidden" coltype="check" title="确认" class="h-button"/>--%>
                </th>
                <th coltype="action">审核确认
                    <msk2:button buttonType="hidden" buttonId="SL241104.SAVEBTN" coltype="save" buttonValue="确认" class="h-button"/>
                    <%--<input type="hidden" coltype="save" title="确认" class="h-button"/>--%>
                </th>
                <th coltype="action">特征信息
                    <msk2:button buttonType="hidden" buttonId="SL241104.DETAILBTN" coltype="detail" buttonValue="特征" class="h-button"/>
                    <%--<input type="hidden" coltype="detail" title="特征" class="h-button"/>--%>
                </th>
                <th coltype="action" width="60px">产品品种图片
                    <msk2:button buttonType="hidden" buttonId="SL241104.SEARCHBTN" coltype="search" buttonValue="产品品种图片" class="h-button"/>
...
<script src="${ctx}/static/sl/js/SL241104.js"></script>
