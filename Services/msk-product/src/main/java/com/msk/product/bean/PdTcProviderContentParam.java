...
import com.msk.core.entity.PdTcProviderContent;
 ...
 */
@ApiModel(value = "PdTcProviderContentParam",description = "卖家供应备案注册标准目录")
public class PdTcProviderContentParam extends PdTcProviderContent {
