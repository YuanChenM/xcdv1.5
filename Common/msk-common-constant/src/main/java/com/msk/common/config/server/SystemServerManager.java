...
public final class SystemServerManager {
    ...
    public static String getModuleRootUrl() {
        RestRequest<ConfigParam> request = new RestRequest<>();
        request.setParam(getConfigParam(MODEL_NAME, StringConstant.EMPTY));
        TypeReference typeReference = new TypeReference<RestResponse<HashMap<String, String>>>() {};
        RestResponse<HashMap<String, String>> response = RestClientUtils.post(getConfigConstantUrl(), request,
            typeReference);
    ...
    public static class BsServerManage {
        ...
        public static String getGetSaleByBuyerId() {
            return getServerUrl(SystemServerDef.BsServer.MODULE_NAME, SystemServerDef.BsServer.GET_SALE_BY_BUYER_ID_SERVER_NAME);
        }
        ...
        public static String getGetHouseInfoById() {
            return getServerUrl(SystemServerDef.BsServer.MODULE_NAME, SystemServerDef.BsServer.GET_HOUSE_INFO_BY_ID_SERVER_NAME);
        }
        ...
        public static String getFindSlcodeAndDisList() {
            return getServerUrl(SystemServerDef.BsServer.MODULE_NAME, SystemServerDef.BsServer.FIND_SL_CODE_AND_DIS_LIST_SERVER_NAME);
        }
        ...
        public static String getUpdateBuyerValidDate() {
            return getServerUrl(SystemServerDef.BsServer.MODULE_NAME, SystemServerDef.BsServer.UPDATE_BUYER_VALID_DATE_SERVER_NAME);
        }
    }
    ...
    public static class BuyersServerManage {
        ...
        public static String getUpdateSalePeriod() {
            return getServerUrl(SystemServerDef.Buyers.MODULE_NAME, SystemServerDef.Buyers.UPDATE_SALE_PERIOD_SERVER_NAME);
        }
    ...
    public static class SellerServerManage {
        ...
        public static String getGetSlEnterpriseBySlCode() {
            return getServerUrl(SystemServerDef.Seller.MODULE_NAME, SystemServerDef.Seller.GET_SL_ENTERPRISE_BY_SL_CODE_SERVER_NAME);
        }
        ...
        public static String getQuerySellerList() {
            return getServerUrl(SystemServerDef.Seller.MODULE_NAME, SystemServerDef.Seller.QUERY_SELLER_LIST_SERVER_NAME);
        }
        ...
        public static String getSearchAllSLEpManager() {
            return getServerUrl(SystemServerDef.Seller.MODULE_NAME, SystemServerDef.Seller.SEARCH_ALL_S_L_EP_MANAGER_SERVER_NAME);
        }
    ...
    public static class SnkPriceServerManage {
        ...
        public static String getGetPriceWayList() {
            return getServerUrl(SystemServerDef.SnkPrice.MODULE_NAME, SystemServerDef.SnkPrice.GETPRICEWAYLIST_SERVER_NAME);
        }
    }
    ...
    public static class SoOrderServerManage {
        ...
        public static String getFindSellers() {
            ...
            return getV1ServerUrl(SystemServerDef.SoOrderV1.MODULE_NAME,
                SystemServerDef.SoOrder.FIND_SELLERS_SERVER_NAME);
        }
        ...
        public static String getCheckReturnCode() {
            return getV1ServerUrl(SystemServerDef.SoOrderV1.MODULE_NAME,
                SystemServerDef.SoOrder.CHECK_RETURN_CODE_SERVER_NAME);
        }
    ...
    public static class SellerSupplyChainManage {
        ...
        public static String getSearchPayment() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.SEARCH_PAYMENT_SERVER_NAME);
        }
        ...
        public static String getSearchContractVerification() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.SEARCH_CONTRACT_VERIFICATION_SERVER_NAME);
        }
        ...
        public static String getFindSscCashPoolingDetail() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_SSC_CASH_POO_LING_DETAIL_SERVER_NAME);
        }
        ...
        public static String getFindSscPaymentRequest() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_SSC_PAYMENT_REQUEST_SERVER_NAME);
        }
        ...
        public static String getFindPaymentRequest() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_PAYMENT_REQUEST_SERVER_NAME);
        }
        ...
        public static String getSaveOrModifyPaymentRequest() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.SAVE_OR_MODIFY_PAYMENT_REQUEST_SERVER_NAME);
        }
        ...
        public static String getFindPaymentInfo() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_PAYMENT_INFO_SERVER_NAME);
        }
        ...
        public static String getSaveOrModifyPaymentInfo() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.SAVE_OR_MODIFY_PAYMENT_INFO_SERVER_NAME);
        }
        ...
        public static String getDeleteSscPaymentRequest() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.DELETE_SSC_PAYMENT_REQUEST_SERVER_NAME);
        }
        ...
        public static String getCalcDelyIntoDiff() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.CALC_DELY_INTO_DIFF_SERVER_NAME);
        }
        ...
        public static String getCalcTranspExpDiff() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.CALC_TRANSP_EXP_DIFF_SERVER_NAME);
        }
        ...
        public static String getFindSscinvoiceRequestList() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_SSCINVOICE_REQUEST_LIST_SERVER_NAME);
        }
        ...
        public static String getModifyInvoiceRequest() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.MODIFY_INVOICE_REQUEST_SERVER_NAME);
        }
        ...
        public static String getContractToNewInvoiceRequestDetail() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.CONTRACT_TO_NEW_INVOICE_REQUEST_DETAIL_SERVER_NAME);
        }
        ...
        public static String getFindInvoiceRequestDetail() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_INVOICE_REQUEST_DETAIL_SERVER_NAME);
        }
        ...
        public static String getContractFindInvoiceRequestDetailExist() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.CONTRACT_FIND_INVOICE_REQUEST_DETAIL_EXIST_SERVER_NAME);
        }
        ...
        public static String getInsertInvoiceRequest() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.INSERT_INVOICE_REQUEST_SERVER_NAME);
        }
        ...
        public static String getModifyInvoiceRequestUp() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.MODIFY_INVOICE_REQUEST_UP_SERVER_NAME);
        }
        ...
        public static String getSearchContractForInvoice() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.SEARCH_CONTRACT_FOR_INVOICE_SERVER_NAME);
        }
        ...
        public static String getSaveInvoiceRequestFileInfo() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.SAVE_INVOICE_REQUEST_FILE_INFO_SERVER_NAME);
        }
        ...
        public static String getAuditVerification() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.AUDIT_VERIFICATION_SERVER_NAME);
        }
        ...
        public static String getSaveOrUpdateVerification() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.SAVE_OR_UPDATE_VERIFICATION_SERVER_NAME);
        }
        ...
        public static String getFindVerificationDetails() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_VERIFICATION_DETAILS_SERVER_NAME);
        }
        ...
        public static String getFindContractPlanInfo() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_CONTRACT_PLANINFO_SERVER_NAME);
        }
        ...
        public static String getFindProducePdControl() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_PRODUCE_PD_CONTROL_SERVER_NAME);
        }
        ...
        public static String getFindStockProductDetail() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_STOCK_PRODUCT_DETAIL_SERVER_NAME);
        }
        ...
        public static String getBatchSaveOrUpdateProducePlan() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.BATCH_SAVE_OR_UPDATE_PRODUCE_PLAN_SERVER_NAME);
        }
        ...
        public static String getBatchSaveOrUpdatePdControl() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.BATCH_SAVE_OR_UPDATE_PD_CONTROL_SERVER_NAME);
        }
        ...
        public static String getFindDeliveryPdControl() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_DELIVERY_PD_CONTROL_SERVER_NAME);
        }
        ...
        public static String getFindDeliveryPDList() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_DELIVERY_PD_LIST_SERVER_NAME);
        }
        ...
        public static String getFindProductHistories() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_PRODUCT_HISTORIES_SERVER_NAME);
        }
        ...
        public static String getFindNoRelatedBidBase() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_NO_RELATED_BID_BASE_SERVER_NAME);
        }
        ...
        public static String getCheckBidBaseExist() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.CHECK_BID_BASE_EXIST_SERVER_NAME);
        }
        ...
        public static String getFindPreIntoListByDeliveryId() {
            return getServerUrl(SystemServerDef.SellerSupplyChain.MODULE_NAME, SystemServerDef.SellerSupplyChain.FIND_PREINTO_LIST_BYDE_LIVERYID_SERVER_NAME);
        }
    }
    ...
    public static class BuyersReportServerManager {
        ...
        public static String getQueryHkGroupForHkInfo() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.QUERY_HK_GROUP_FOR_HK_INFO);
        }
        ...
        public static String getQueryFileBuyerPools() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.QUERY_FILE_BUYER_POOLS_SERVER_NAME);
        }
        ...
        public static String getGenerateAndUploadExcelFiles() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.GENERATE_AND_UPLOAD_EXCEL_FILES_SERVER_NAME);
        }
        ...
        public static String getGenerateAndUploadOnlineExcelFiles() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.GENERATE_AND_UPLOAD_ONLINE_EXCEL_FILES_SERVER_NAME);
        }
        ...
        public static String getByReportSearch() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.BY_REPORT_SEARCH_SERVER_NAME);
        }
        ...
        public static String getBuyerPoolFileCreate() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.BUYER_POOL_FILE_CREATE_SERVER_NAME);
        }
        ...
        public static String getFindMarketNameListByLevel() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.FIND_MARKET_NAME_LIST_BY_LEVEL_SERVER_NAME);
        }
        ...
        public static String getCreateMarketingPeriodExcel() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.CREATE_MARKETING_PERIOD_EXCEL_SERVER_NAME);
        }
        ...
        public static String getCreateSalesPeriodExcel() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.CREATE_SALES_PERIOD_EXCEL_SERVER_NAME);
        }
        ...
        public static String getSearchPubliBuyerPoolInformation() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.SEARCH_PUBLI_BUYER_POOL_INFORMATION_SERVER_NAME);
        }
        ...
        public static String getExclusiveExcelFilesSave() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.EXCLUSIVE_EXCEL_FILES_SAVE_SERVER_NAME);
        }
        ...
        public static String getGetSaleInfoByBuyerId() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.GET_SALE_INFO_BY_BUYER_ID_SERVER_NAME);
        }
        ...
        public static String getQueryBrBuyerPoolByBuyerId() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.QUERY_BR_BUYER_POOL_BY_BUYER_ID_SERVER_NAME);
        }
        ...
        public static String getAddHkGroup() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.ADD_HK_GROUP_SERVER_NAME);
        }
        ...
        public static String getSynMarketingStatusByOrder() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.SYN_MARKETING_STATUS_BY_ORDER_SERVER_NAME);
        }
        ...
        public static String getUpdateMarketingAndSalePeriod() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.UPDATE_MARKETING_PERIOD_SERVER_NAME);
        }
        ...
        public static String getSynBuyerPdClasses() {
            return getServerUrl(SystemServerDef.BuyersReport.MODULE_NAME, SystemServerDef.BuyersReport.SYN_BUYER_PD_CLASSES_SERVER_NAME);
        }
    ...
    public static class SsoServerManager {
        public static String getCasServerLogoutUrl() {
            ...
            //return getServerUrl(SystemServerDef.SsoServer.MODULE_NAME, SystemServerDef.SsoServer.CAS_SERVER_LOGOUT_URL);
            return getCasServerUrlPrefix()+"/logout";
        }

        public static String getCasServerLoginUrl() {
            //return getServerUrl(SystemServerDef.SsoServer.MODULE_NAME, SystemServerDef.SsoServer.CAS_SERVER_LOGIN_URL);
            return getCasServerUrlPrefix()+"/login";
        }

        public static String getCasServerUrlPrefix() {
            ConfigParam param = getConfigParam(SystemServerDef.SsoServer.MODULE_NAME,SystemServerDef.SsoServer.CAS_SERVER_URL_PREFIX_URL);
            RestRequest<ConfigParam> request = new RestRequest<>();
            request.setParam(param);
            TypeReference typeReference = new TypeReference<RestResponse<HashMap<String, String>>>() {};
            RestResponse<HashMap<String, String>> response = RestClientUtils.post(getConfigConstantUrl(), request, typeReference);
            HashMap<String, String> result = response.getResult();
    ...
    public static class CommonServerManager {
        ...
        public static String getCreateDistributionOrder() {
            return getCommonServerUrl(SystemServerDef.CommonServer.MODULE_NAME,
                    SystemServerDef.CommonServer.CREATE_DISTRIBUTION_ORDER_SERVER_NAME);
        }
        ...
        public static String getGetFlieServerUploadForJsp() {
            return getCommonServerUrl(SystemServerDef.CommonServer.MODULE_NAME, SystemServerDef.CommonServer.GET_FLIE_SERVER_UPLOAD_FOR_JSP_SERVER_NAME);
        }
        ...
        public static String getMskFlieDownLoad() {
            return getCommonServerUrl(SystemServerDef.CommonServer.MODULE_NAME, SystemServerDef.CommonServer.MSK_FLIE_DOWN_LOAD_SERVER_NAME);
        }
...
//        }
    ...
    public static class PrintServerManager {
        ...
        public static String getNetworkAddress() {
            ConfigParam param = getConfigParam(SystemServerDef.PrintServer.MODULE_NAME,SystemServerDef.PrintServer.NETWORK_ADDRESS);
            RestRequest<ConfigParam> request = new RestRequest<>();
            request.setParam(param);
            TypeReference typeReference = new TypeReference<RestResponse<HashMap<String, String>>>() {};
            RestResponse<HashMap<String, String>> response = RestClientUtils.post(getConfigConstantUrl(), request, typeReference);
        ...
        public static String getAsyncGenerateSinglePDF() {
            return getServerUrl(SystemServerDef.PrintServer.MODULE_NAME, SystemServerDef.PrintServer.ASYNC_GENERATE_SINGLE_PDF);
        }
    }
    ...
    */
    public static class SoInventoryServerManager {
        ...
        public static String getGetStockListByPdCode() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.GET_STOCK_LIST_BY_PD_CODE_SERVER_NAME);
        }
        ...
        public static String getInboundInventory() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.INBOUND_INVENTORY_SERVER_NAME);
        }
        ...
        public static String getAllocateSlInventory() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.ALLOCATE_SL_INVENTORY_SERVER_NAME);
        }
        ...
        public static String getAllocateOwnerInventory() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.ALLOCATE_OWNER_INVENTORY_SERVER_NAME);
        }
        ...
        public static String getUndoAllocateSlInventory() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.UNDO_ALLOCATE_SL_INVENTORY_SERVER_NAME);
        }
        ...
        public static String getUndoAllocateOwnerInventory() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.UNDO_ALLOCATE_OWNER_INVENTORY_SERVER_NAME);
        }
        ...
        public static String getOutboundInventory() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.OUTBOUND_INVENTORY_SERVER_NAME);
        }
        ...
        public static String getFindProductStock() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.FIND_PRODUCT_STOCK_SERVER_NAME);
        }
        ...
        public static String getFindSlProductIvList() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.FIND_SL_PRODUCT_IV_LIST_SERVER_NAME);
        }
        ...
        public static String getFindSpProductIvList() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.FIND_SP_PRODUCT_IV_LIST_SERVER_NAME);
        }
        ...
        public static String getFindSlProductList() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.FIND_SL_PRODUCT_LIST_SERVER_NAME);
        }
        ...
        public static String getAssignInventoryForSl() {
            return getServerUrl(SystemServerDef.SoInventoryServer.MODULE_NAME, SystemServerDef.SoInventoryServer.ASSIGN_INVENTORY_FOR_SL_SERVER_NAME);
        }
   ...
   */
    public static class SoOrderApiServerManager {
        ...
        public static String getCreateSoPro() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CREATE_SO_PRO_SERVER_NAME);
        }
        ...
        public static String getQuerySoDetailPrintInfo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SO_DETAIL_PRINT_INFO_SERVER_NAME);
        }
        ...
        public static String getQueryReceiptInfo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_RECEIPT_INFO_SERVER_NAME);
        }
        ...
        public static String getQueryPdSalesVolumnList() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_PD_SALES_VOLUMN_LIST_SERVER_NAME);
        }
        ...
        public static String getQueryOrderSourceCount() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_ORDER_SOURCE_COUNT_SERVER_NAME);
        }
        ...
        public static String getCreateSoReturnInvoice() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CREATE_SO_RETURN_INVOICE_SERVER_NAME);
        }
        ...
        public static String getQuerySoReturnInvoice() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SO_RETURN_INVOICE_SERVER_NAME);
        }
        ...
        public static String getCancelTotalSoOrder() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CANCEL_TOTAL_SO_ORDER_SERVER_NAME);
        }
        ...
        public static String getDeleteSoOrder() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.DELETE_SO_ORDER_SERVER_NAME);
        }
        ...
        public static String getPaySoOrder() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.PAY_SO_ORDER_SERVER_NAME);
        }
        ...
        public static String getCreateDistributeSdo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CREATE_DISTRIBUTE_SDO_SERVER_NAME);
        }
        ...
        public static String getCreateBuyerSdo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CREATE_BUYER_SDO_SERVER_NAME);
        }
        ...
        public static String getCreateThirdPartySdo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CREATE_THIRD_PARTY_SDO_SERVER_NAME);
        }
        ...
        public static String getCreateThirdBuyerSdo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CREATE_THIRD_BUYER_SDO_SERVER_NAME);
        }
        ...
        public static String getCeliverSoOrder() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CELIVER_SO_ORDER_SERVER_NAME);
        }
        ...
        public static String getReceiptSoOrder() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.RECEIPT_SO_ORDER_SERVER_NAME);
        }
        ...
        public static String getQuerySdoList() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SDO_LIST_SERVER_NAME);
        }
        ...
        public static String getQueryBySdoList() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_BY_SDO_LIST_SERVER_NAME);
        }
        ...
        public static String getQuerySlSdoList() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SL_SDO_LIST_SERVER_NAME);
        }
        ...
        public static String getQueryBssSdoList() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_BSS_SDO_LIST_SERVER_NAME);
        }
        ...
        public static String getQueryBssgSdoList() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_BSSG_SDO_LIST_SERVER_NAME);
        }
        ...
        public static String getQuerySdoDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SDO_DETAIL_SERVER_NAME);
        }
        ...
        public static String getQueryBySdoDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_BY_SDO_DETAIL_SERVER_NAME);
        }
        ...
        public static String getQuerySlSdoDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SL_SDO_DETAIL_SERVER_NAME);
        }
        ...
        public static String getQueryBssSdoDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_BSS_SDO_DETAIL_SERVER_NAME);
        }
        ...
        public static String getQueryBssgSdoDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_BSSG_SDO_DETAIL_SERVER_NAME);
        }
        ...
        public static String getQuerySoSlProductList() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SO_SL_PRODUCT_LIST_SERVER_NAME);
        }
        ...
        public static String getQoOrderInbound() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QO_ORDER_INBOUND_SERVER_NAME);
        }
        ...
        public static String getQuerySellerInfo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SELLER_INFO_SERVER_NAME);
        }
        ...
        public static String getQueryBuyerInfo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_BUYER_INFO_SERVER_NAME);
        }
        ...
        public static String getQueryHouseKeepingInfo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_HOUSE_KEEPING_INFO_SERVER_NAME);
        }
        ...
        public static String getQueryHouseKeepingDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_HOUSE_KEEPING_DETAIL_SERVER_NAME);
        }
        ...
        public static String getQuerySdoSettlementDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SDO_SETTLEMENT_DETAIL_SERVER_NAME);
        }
        ...
        public static String getQuerySdoBuyRecord() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SDO_BUY_RECORD_SERVER_NAME);
        }
        ...
        public static String getCancelSdoShipment() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CANCEL_SDO_SHIPMENT_SERVER_NAME);
        }
        ...
        public static String getQueryOrderHalfMonthCount() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_ORDER_HALF_MONTH_COUNT_SERVER_NAME);
        }
        ...
        public static String getGetSoOrderInfo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.GET_SO_ORDER_INFO_SERVER_NAME);
        }
        ...
        public static String getReceiveSoOrderLater() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.RECEIVE_SO_ORDER_LATER_SERVER_NAME);
        }
        ...
        public static String getReceiveSoOrderReject() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.RECEIVE_SO_ORDER_REJECT_SERVER_NAME);
        }
        ...
        public static String getQuerySdoShipDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SDO_SHIP_DETAIL_SERVER_NAME);
        }
        ...
        public static String getQueryReturnReason() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_RETURN_REASON_SERVER_NAME);
        }
        ...
        public static String getFindPageOrderList() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.FIND_PAGE_ORDER_LIST_SERVER_NAME);
        }
        ...
        public static String getFindPageOrderDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.FIND_PAGE_ORDER_DETAIL_SERVER_NAME);
        }
        ...
        public static String getFindPageReturnOrderList() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.FIND_PAGE_RETURN_ORDER_LIST_SERVER_NAME);
        }
        ...
        public static String getFindPageReturnOrderDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.FIND_PAGE_RETURN_ORDER_DETAIL_SERVER_NAME);
        }
        ...
        public static String getFindPageBaseReturn() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.FIND_PAGE_BASE_RETURN_SERVER_NAME);
        }
        ...
        public static String getFindByBasicAndOrderDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.FIND_BY_BASIC_AND_ORDER_DETAIL_SERVER_NAME);
        }
        ...
        public static String getQuerySellerProductInfo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SELLER_PRODUCT_INFO_SERVER_NAME);
        }
        ...
        public static String getQuerySupplierProductInfo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_SUPPLIER_PRODUCT_INFO_SERVER_NAME);
        }
        ...
        public static String getQueryDeliverInfo() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.QUERY_DELIVER_INFO_SERVER_NAME);
        }
        ...
        public static String getCancelOrderDeliver() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.CANCEL_ORDER_DELIVER_SERVER_NAME);
        }
        ...
        public static String getExportOrderDetail() {
            return getServerUrl(SystemServerDef.SoOrderApiServer.MODULE_NAME, SystemServerDef.SoOrderApiServer.EXPORT_ORDER_DETAIL_SERVER_NAME);
        }
