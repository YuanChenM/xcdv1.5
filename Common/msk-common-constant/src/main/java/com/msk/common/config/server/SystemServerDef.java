...
public interface SystemServerDef {
    ...
    */
    interface SoOrder {
        /**模块名称*/String MODULE_NAME = "SO-ORDER";
        //String	MODIFY_DB_ORDER	=	"Modify_Db_Order";
    ...
    */
    interface SoOrderApiServer{
        ...
        /**接收WMS系统处理完退货后，返回的入库信息接口，处理完成后，系统内库存增加*/String QO_ORDER_INBOUND_SERVER_NAME = "QoOrderInbound";
        /**卖家快捷信息查询*/
        ...
        /**接收司机PDA系统的迟收退货信息，OMS处理后可再通知WMS发货*/String RECEIVE_SO_ORDER_LATER_SERVER_NAME = "ReceiveSoOrderLater";
        /**接收司机PDA系统的现场拒收退货信息*/
